...
log_dir = "logs"
os.mkdir(log_dir,exist_ok = True)ssssss
...
def prepare_base_model(config_path,params_path):
    ...
    artifacts_dir = artofacts['ARTIFACTS_DIR']
    ...
    model = get_VGG16_base_model(input_shape=params["IMAGE_SIZE"], model_path=base_model_path)
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.info("stage two completed and base model created>>>>>")
